                ...
                <div class="uk-upload-item-wrap">
                    <div class="uk-upload-item-content">
                        ...
                        <div class="uk-upload-mask" :class="{'uk-upload-mask-error':file.status === 'error'}" v-show="file.status!=='success'">
                            ...
                            <span class="uk-upload-error" v-if="file.status==='error'"><i class="iconfont icon-error"></i></span>
                            <span class="uk-upload-retry" @click="reload(file)" title="重试"><i class="iconfont icon-zhongfa"></i></span>
                        </div>
                ...
                <div class="uk-upload-list-name uk-upload-clearfix">
                    ...
                    <span class="uk-upload-list-icons uk-upload-right" v-if="!previewMode">
                        ...
                        <template v-if="file.status === 'error'">
                            <span class="uk-upload-list-retry" title="重试" @click="reload(file)"><i class="iconfont icon-zhongfa"></i></span>
                ...
                propFix:function(){
                    ...
                    this.fileList.forEach(function (file,index) {
                       ...
                       if(file.type === undefined){
                           file.type = _self.getFileType(file);
                       }
                   });
                },
